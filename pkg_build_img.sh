...
if [ ! -f ${SERVICE_HOME}/pkg_build_img.sh ]; then
echo "${SERVICE_HOME}/pkg_build_img.sh not exist"
exit 1
else
sh ${SERVICE_HOME}/pkg_build_img.sh ${TARGET_ENV} ${REDEPLOY_CONFIGMAP} ${REDEPLOY_TAG}
fi
